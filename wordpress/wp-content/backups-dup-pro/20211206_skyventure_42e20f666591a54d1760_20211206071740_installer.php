...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20211206_skyventure_42e20f666591a54d1760_20211206071740_archive.daf';
    const ARCHIVE_SIZE       = '46872366';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '42e20f6-06071740';
    const VERSION            = '3.8.7';
